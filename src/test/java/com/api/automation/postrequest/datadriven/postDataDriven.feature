Feature: To create job description in the test application
  ...
  Background: Read the data fo data driven
  ...
  Scenario Outline: Data Driven for the job description entry - <jobId>
    ...
    And request {"jobId":'#(jobId)',"jobTitle":'#(jobTitle)',"jobDescription":'#(jobDescription)',"experience":["Google","Apple","Mobile Iron","Subex"],"project":[{"projectName":"Movie App","technology":["Kotlin","SQL Lite","Gradle","Jenkins"]}]}
